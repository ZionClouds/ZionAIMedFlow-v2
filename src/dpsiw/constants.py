class constants:
    DIPS_MESSAGES_QUEUE = 'dips-messages'

    TABLE_PHYSICIANS = 'physicians'
    TABLE_EVENTS = 'events'
    TABLE_MESSAGES = 'messages'

    SERVICE_SETTINGS = 'settings'
    SERVICE_MESSAGES_QUEUE = 'messages_queue'
    SERVICE_PHYSICIAN_REPOSITORY = 'physician_repository'
    SERVICE_EVENTS_REPOSITORY = 'events_repository'
